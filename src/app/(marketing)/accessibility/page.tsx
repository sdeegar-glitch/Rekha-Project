  ...
  return (
    <div className="container mx-auto py-24 px-4 max-w-4xl">
      ...
      <section className="mb-8 space-y-4 text-muted-foreground">
        ...
        <p>We are continually improving the user experience for everyone and applying the relevant accessibility standards to our website.</p>
        
        <h2 className="text-2xl font-semibold text-foreground">2. Feedback</h2>
        <p>We welcome your feedback on the accessibility of our website. If you encounter any accessibility barriers, please contact us so we can assist you.</p>
      </section>
    </div>
  )
}
